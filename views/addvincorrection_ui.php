...
<div class="width700px">
	<div class="topgrayBG padTop10px padLeft15px">
		<div class="alignleft marTop3px"><h2><?php echo $constantArr['Addlbl'][$_SESSION['lang']].' '.$constantArr['vincorrection'][$_SESSION['lang']]; ?></h5></div>
		...
		<form action="/vincorrection/" method="post" enctype="multipart/form-data" name="vincorrectionform" id="vincorrectionform">
			<div>
				<p class="marTop0px">
					...
					<input type="text" class="txtBox200px" id="previn" name="previn" maxlength="17" onblur="return checkVIN(this.id,this.value,'errorMessage','txtBox200px','errorBdr txtBox200px');" />
					<a id="PVINval" href="javascript:void(0)">
				...
				<p>
					...
					<input type="text" class="txtBox200px" id="vin" name="vin" maxlength="17" onblur="return checkVIN(this.id,this.value,'errorMessage','txtBox200px','errorBdr txtBox200px');" onkeyPress="validateVin(this.id);"/>
				...
				<p>
					...
					<select class="txtBox150px" name="grossWeightCategory" id="grossWeightCategory">
				...
				<p>
					...
					<label class="small">&nbsp;</label>
					<input type="hidden" name="selectedFilingId" value="new" />
					<input type="submit" name="addvincorrection" onclick="return validateVINCorrection();" class="blueButn100px" value="<?php echo $constantArr['savebtn'][$_SESSION['lang']]; ?>" />
